...
db = SQL("sqlite:////home/shoprighthere/mysite/project.db")
...
def update():
    ...
    with open("/home/shoprighthere/mysite/product.csv", 'r') as csvfile:
...
def homepage():
    ...
    if request.method=="GET":
        ...
        if request.form.get("new_product")!="" and request.form.get("new_product")!=None and request.form.get("new_description")!="" and request.form.get("new_unit")!="" and request.form.get("new_unit_cost")!="":
            print(request.form.get("new_product"))
...
def history():
    ...
    # else:
        ...
        return render_template("history.html", rows=rows, total_value=total_value, username=session["username"], message=message)
